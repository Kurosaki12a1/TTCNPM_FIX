...
public class FollowerPopUp extends Activity {
    ...
    protected  void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(FollowerPopUp.this));
    ...
    private void setRecyclerView(ArrayList<UserFollowInfo> list){
        FollowAdapter followAdapter=new FollowAdapter(FollowerPopUp.this,list);
