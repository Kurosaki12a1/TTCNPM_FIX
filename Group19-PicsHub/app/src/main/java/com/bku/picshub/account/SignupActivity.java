package com.bku.picshub.account;
...
public class SignupActivity extends AppCompatActivity {
    ...
    DatabaseReference databaseReference,databaseReference2nd,databaseReference3rd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference2nd=FirebaseDatabase.getInstance().getReference(Follower_Path);
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    databaseReference2nd.child(userId).setValue("Follower of this User");
                                    databaseReference3rd.child(userId).setValue("Following of this User");
